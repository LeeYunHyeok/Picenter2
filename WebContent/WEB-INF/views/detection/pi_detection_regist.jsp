...
%>
<div id="taskWindow" style="position:absolute; left: 650px; top: 240px; touch-action: none; width: 50%; height: 300px; z-index: 999; display:none; width: 70%; max-width: 70%; min-width: 30%; min-height: 200px;" class="ui-widget-content">
	<table class="mxWindow" style="width: 100%; height: 100%;">
	<tbody>
		<tr>
